...
Take 25% of the first semester marks
Take 25 % of the second semester marks.
 Take 50 % of the final  semester marks
 */

#include <stdio.h>
int main()
{
    // first,second and final semester marks for 40 students.
